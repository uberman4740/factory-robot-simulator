...
LABELING_NETWORK_USE_LAYER = None

# LABELING_NETWORK_FILE_NAME = 'saved-nns/autoenc'
# LABELING_NETWORK_USE_LAYER = -2
...
EPSILON_START = 1.00
EPSILON_END = 0.00
EPSILON_DECREASE_DURATION = 10*60*30
